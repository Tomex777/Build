...
object KeyboardIcons {
    val Clipboard: ImageVector = lineIcon("KeyboardClipboard") {
        moveTo(9f, 5f); lineTo(7f, 5f); curveTo(5.9f, 5f, 5f, 5.9f, 5f, 7f); lineTo(5f, 19f)
        curveTo(5f, 20.1f, 5.9f, 21f, 7f, 21f); lineTo(17f, 21f); curveTo(18.1f, 21f, 19f, 20.1f, 19f, 19f); lineTo(19f, 7f)
        curveTo(19f, 5.9f, 18.1f, 5f, 17f, 5f); lineTo(15f, 5f)
        moveTo(9f, 5f); curveTo(9f, 3.9f, 9.9f, 3f, 11f, 3f); lineTo(13f, 3f); curveTo(14.1f, 3f, 15f, 3.9f, 15f, 5f)
        lineTo(15f, 6.5f); lineTo(9f, 6.5f); close()
    }

    val Emoji: ImageVector = lineIcon("KeyboardEmoji") {
        moveTo(12f, 3.5f); curveTo(7.3f, 3.5f, 3.5f, 7.3f, 3.5f, 12f); curveTo(3.5f, 16.7f, 7.3f, 20.5f, 12f, 20.5f)
        curveTo(16.7f, 20.5f, 20.5f, 16.7f, 20.5f, 12f); curveTo(20.5f, 7.3f, 16.7f, 3.5f, 12f, 3.5f); close()
        moveTo(8.6f, 9.4f); lineTo(8.62f, 9.4f)
        moveTo(15.38f, 9.4f); lineTo(15.4f, 9.4f)
        moveTo(8.2f, 13.6f); curveTo(9f, 15.2f, 10.25f, 16f, 12f, 16f); curveTo(13.75f, 16f, 15f, 15.2f, 15.8f, 13.6f)
    }

    val Voice: ImageVector = lineIcon("KeyboardVoice") {
        moveTo(12f, 4f); curveTo(10.35f, 4f, 9f, 5.35f, 9f, 7f); lineTo(9f, 12f); curveTo(9f, 13.65f, 10.35f, 15f, 12f, 15f)
        curveTo(13.65f, 15f, 15f, 13.65f, 15f, 12f); lineTo(15f, 7f); curveTo(15f, 5.35f, 13.65f, 4f, 12f, 4f); close()
        moveTo(6.5f, 11.5f); lineTo(6.5f, 12.2f); curveTo(6.5f, 15.25f, 8.95f, 17.7f, 12f, 17.7f); curveTo(15.05f, 17.7f, 17.5f, 15.25f, 17.5f, 12.2f); lineTo(17.5f, 11.5f)
        moveTo(12f, 17.7f); lineTo(12f, 21f); moveTo(9.2f, 21f); lineTo(14.8f, 21f)
    }

    val Editor: ImageVector = lineIcon("KeyboardEditor") {
        moveTo(5f, 19f); lineTo(8.1f, 18.35f); lineTo(18.5f, 7.95f); curveTo(19.2f, 7.25f, 19.2f, 6.15f, 18.5f, 5.45f); curveTo(17.8f, 4.75f, 16.7f, 4.75f, 16f, 5.45f)
    ...
    val Research: ImageVector = lineIcon("KeyboardResearch") {
        moveTo(10.5f, 4.5f); curveTo(7.2f, 4.5f, 4.5f, 7.2f, 4.5f, 10.5f); curveTo(4.5f, 13.8f, 7.2f, 16.5f, 10.5f, 16.5f)
        curveTo(13.8f, 16.5f, 16.5f, 13.8f, 16.5f, 10.5f); curveTo(16.5f, 7.2f, 13.8f, 4.5f, 10.5f, 4.5f); close()
    ...
    val InputPicker: ImageVector = lineIcon("KeyboardInputPicker") {
        moveTo(4f, 6f); curveTo(4f, 5.45f, 4.45f, 5f, 5f, 5f); lineTo(19f, 5f); curveTo(19.55f, 5f, 20f, 5.45f, 20f, 6f); lineTo(20f, 16f)
        curveTo(20f, 16.55f, 19.55f, 17f, 19f, 17f); lineTo(13.8f, 17f); moveTo(4f, 6f); lineTo(4f, 16f); curveTo(4f, 16.55f, 4.45f, 17f, 5f, 17f); lineTo(10.2f, 17f)
    ...
    val Backspace: ImageVector = lineIcon("KeyboardBackspace") {
        moveTo(9f, 6f); lineTo(20f, 6f); curveTo(20.55f, 6f, 21f, 6.45f, 21f, 7f); lineTo(21f, 17f); curveTo(21f, 17.55f, 20.55f, 18f, 20f, 18f); lineTo(9f, 18f)
    ...
    val Enter: ImageVector = lineIcon("KeyboardEnter") {
        moveTo(19f, 5f); lineTo(19f, 11f); curveTo(19f, 12.65f, 17.65f, 14f, 16f, 14f); lineTo(6f, 14f)
    ...
    val Globe: ImageVector = lineIcon("KeyboardGlobe") {
        ...
        moveTo(12f, 3.5f); curveTo(9.8f, 5.8f, 8.6f, 8.65f, 8.6f, 12f); curveTo(8.6f, 15.35f, 9.8f, 18.2f, 12f, 20.5f)
        moveTo(12f, 3.5f); curveTo(14.2f, 5.8f, 15.4f, 8.65f, 15.4f, 12f); curveTo(15.4f, 15.35f, 14.2f, 18.2f, 12f, 20.5f)
    }
